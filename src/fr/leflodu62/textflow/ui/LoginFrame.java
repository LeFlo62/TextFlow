...
private static final long serialVersionUID = -646263653674647912L;
	...
	public LoginFrame(TextFlow instance) {
		...
		final TitleBar bar = new TitleBar(this, "Login", (e) -> instance.close());
		contentPane.add(bar);
		...
		connectButton = new TextButton("Connexion", e -> instance.attemptLogin());
		...
		final JLabel registerLabel = new ClickableLabel("<html><u>Register</u></html>", e -> instance.openFrame(new RegisterFrame(instance)));
		registerLabel.setBounds(10, 355, 48, 14);
		contentPane.add(registerLabel);
		
		addKeyListener(instance.getLoginEnterKeyListener());
		usernameField.addKeyListener(instance.getLoginEnterKeyListener());
		passwordField.addKeyListener(instance.getLoginEnterKeyListener());
	}
	...
	public void giveCreditentials(ClientConnection connection) {
		connection.connect(this, getUsername(), new String(passwordField.getPassword()));
